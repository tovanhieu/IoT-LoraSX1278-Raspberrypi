...
//    rf95.send((uint8_t *)radiopacket, 4);
    Serial.println("Send: INF1");
    char radiopacket[5] = "INF1";
    ...
    delay(10);
    rf95.waitPacketSent();
    rf95.send((uint8_t *)dtostrf(tem,3,1,radiopacket1), sizeof(radiopacket1));
    delay(10);
    rf95.waitPacketSent();
    rf95.send((uint8_t *)dtostrf(hum,3,1,radiopacket2), sizeof(radiopacket2));
    delay(10);
    rf95.waitPacketSent();
